  ...
  return (
    <View style={styles.mainContainer}>
      <View
        ...
        />
        <View style={{marginTop: spacing.MARGIN_14, width: spacing.WIDTH_290}}>
          ...
          <View style={styles.courseDetailesDateContainer}>
            <View style={styles.applicationDateStyle}>
              ...
              />
              <TextComp text={item.Application_date} style={styles.dateStyle} />
            </View>
        ...
        <TouchableOpacity
          onPress={() => setIsOptionSelect(!isOptionSelect)}
          activeOpacity={0.7}>
      ...
      <View style={styles.bottonCotainer}>
        ...
        <BottonComp
          text="How To Apply"
          style={{width: spacing.WIDTH_116, height: spacing.HEIGHT_40}}
        />
      </View>
      {isOptionSelect ? (
        <View
